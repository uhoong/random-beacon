...
public:
    ...
    ReplicaConfig(size_t _nreplicas = 0, size_t _nreconthres = 0,size_t _probility=100,size_t _k=0) : nreplicas(_nreplicas), nreconthres(_nreconthres),probility(_probility),k(_k) {}
